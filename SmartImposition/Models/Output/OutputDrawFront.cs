...
{
    public class OutputDrawFront : IOutputDraw
    {
        ...
        public OutputDrawFront(TemplateContainer container, IInputFileController inputFileController, TemplatePressSheet templatePressSheet)
        {
